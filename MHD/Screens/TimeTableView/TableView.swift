...
class TableView: UIView {
    ...
    // MARK: - Variables
    private let dayTypeSchedules: [CDDayTypeSchedule]
    ...
    // MARK: - Initialization
    init(dayTypeSchedules: [CDDayTypeSchedule]) {
...
private extension TableView {
    ...
    func setCurrentDayType() {
        ...
        if let currentDayTypeIndex = findFirstSegmentIndex(withTitle: currentDayType.description) {
